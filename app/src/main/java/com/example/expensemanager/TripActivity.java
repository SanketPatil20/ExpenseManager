...
import com.example.expensemanager.TripAdapter;
//
...
public class TripActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        findViewById(R.id.btnAddTrip).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        if (result.getCount() != 0) {
            ...
            tvEmpty.setText("Click on 'Add Trip' to add new trip");
        }
    }
